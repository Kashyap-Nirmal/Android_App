...
public final class FaceActivity extends AppCompatActivity {
  ...
  private void requestCameraPermission() {
    ...
    Toast.makeText(getApplicationContext(), "Camera permission not acquired. Requesting permission.", Toast.LENGTH_SHORT).show();
  ...
  public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    if (requestCode != RC_HANDLE_CAMERA_PERM) {
      ...
      Toast.makeText(getApplicationContext(), "Got unexpected permission result: " + requestCode, Toast.LENGTH_SHORT).show();
    ...
    if (grantResults.length != 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
      ...
      Toast.makeText(getApplicationContext(), "Camera permission granted - initializing camera source.", Toast.LENGTH_SHORT).show();
      createCameraSource();
      return;
    }
  ...
  private void startCameraSource() {
    ...
    if (mCameraSource != null) {
      try {
        ...
        Toast.makeText(getApplicationContext(), "Unable to start camera source."+e, Toast.LENGTH_SHORT).show();
  ...
  private FaceDetector createFaceDetector(final Context context) {
    ...
    if (!detector.isOperational()) {
      ...
      Toast.makeText(getApplicationContext(), "Face detector dependencies are not yet available.", Toast.LENGTH_SHORT).show();
      ...
      if (hasLowStorage) {
        ...
        Toast.makeText(getApplicationContext(), R.string.low_storage_error , Toast.LENGTH_SHORT).show();
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int id) {
            finish();
          }
